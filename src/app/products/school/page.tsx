          ...
          <div className="relative rounded-2xl overflow-hidden border border-gray-200/80 shadow-2xl shadow-gray-300/40">
            <div className="bg-gray-100 border-b border-gray-200 px-4 py-3 flex items-center gap-2">
              ...
              <div className="flex-1 mx-3 bg-white rounded-md border border-gray-200 px-3 py-1 text-xs text-gray-400 font-mono">
                school.ravesoftsolutions.com
              </div>
            </div>
            <Image
              src="/img/school-management-system-dashboard.png"
              alt="School Management System dashboard showing student records, fees, attendance, and academic reports"
              width={1280}
              height={720}
      ...
      <section className="bg-white border-t border-gray-100 py-10">
        <div className="max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/case-studies/school-system" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-sm font-medium text-gray-700 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 transition-all">Case Study: School System →</Link>
            <Link href="/blog/best-school-management-system-ghana-nigeria" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-sm font-medium text-gray-700 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 transition-all">Best SMS in Ghana &amp; Nigeria →</Link>
            <Link href="/industries/education" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-sm font-medium text-gray-700 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 transition-all">Education Solutions →</Link>
          </div>
        </div>
      </section>
